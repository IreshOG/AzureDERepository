...
, SECRET = '?sv=2020-08-04&ss=b&srt=sco&sp=rwlac&se=2021-12-07T14:44:25Z&st=2021-11-30T06:44:25Z&spr=https&sig=Fgwz3FRdp1otIaGKKVm0GXOenmTxmm9SZpIEFwsxQTE%3D';

-- This defines the source of the data. 

CREATE EXTERNAL DATA SOURCE log_data
WITH (    LOCATION   = 'https://dataforbigdata345.dfs.core.windows.net/data',
          CREDENTIAL = SasToken
)
